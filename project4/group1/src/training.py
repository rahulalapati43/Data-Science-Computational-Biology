...
def main(pssmFiles, rrFiles, minibatchSize):
    ...
    if minibatchSize is not None:
        ...
        weights = ga.gradientAscent(ga.learningRate, epsilon, ga.predict, ga.getDeltaMCLE, partial(ga.getSubsetMiniBatch, minibatchSize), instances)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--minibatch', help='Do minibatch of size s instead of stochastic', nargs=1, default=None)
